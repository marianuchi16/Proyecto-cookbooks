...
uses Unit3, Unit1, Unit13, Unit11;
...
begin
   ...
   begin
      messagedlg('Las contraseñas son diferentes!!',mtinformation,[mbok],0);
      edit13.Text:='';
      edit10.Text:='';
   end;
end
...
begin
form3.ADOhistorial.close;
form3.ADOhistorial.Parameters.ParamByName('par1').Value:= id;
form3.ADOhistorial.Open;
form11.DBGrid1.Refresh;
form11.ShowModal;
end;
...
begin
      ...
      begin
          ...
          form4.Edit13.Text:= form3.ADOUSUARIO.FieldByName('Contraseña').AsString;
          form4.Edit10.Text:= form3.ADOUSUARIO.FieldByName('Contraseña').AsString;
      end
      else
      begin
          usuario:= form3.ADOCLIENTE.FieldByName('Id_Cliente').AsInteger;
